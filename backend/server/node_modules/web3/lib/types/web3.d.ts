...
export declare class Web3<CustomRegisteredSubscription extends {
    ...
    static requestEIP6963Providers: () => Promise<import("../../src/web3_eip6963.js").EIP6963ProviderResponse>;
    static onNewProviderDiscovered: (callback: (providerEvent: import("../../src/web3_eip6963.js").EIP6963ProvidersMapUpdateEvent) => void) => void;
    static modules: {
