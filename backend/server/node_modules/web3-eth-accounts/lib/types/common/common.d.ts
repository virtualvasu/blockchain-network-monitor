...
import type { ConsensusAlgorithm, ConsensusType } from '../../../src/common/enums.js';
import { Chain, CustomChain, Hardfork } from '../../../src/common/enums.js';
import type { BootstrapNodeConfig, CasperConfig, ChainConfig, ChainsConfig, CliqueConfig, CommonOpts, CustomCommonOpts, EthashConfig, GenesisBlockConfig, GethConfigOpts, HardforkConfig } from '../../../src/common/types.js';
/**
